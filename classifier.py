...
async def _classify_batch_with_gemini(batch: list, api_key: str, model: str):
    ...
    prompt = (
        ...
        "  - Fashion feed (is_fashion=true): clothing, shoes, bags, accessories,\n"
        "    AND jewelry. These are all 'wearable' categories that belong\n"
        "    together on the Fashion tab — accessories like hats/belts/sunglasses\n"
        "    and jewelry like earrings/necklaces/rings are part of fashion, not\n"
        "    the General tab.\n"
        ...
        "  1. is_fashion: true for clothing, shoes, bags, accessories OR jewelry.\n"
        "                 False for electronics/home/beauty/health/food/toys-books/other.\n"
        ...
        "     - fashion          (clothing or shoes — is_fashion=true)\n"
        ...
        "     - accessories      (hats, caps, beanies, scarves, belts, sunglasses,\n"
        "                         gloves, ties, umbrellas — is_fashion=true)\n"
        ...
        "FASHION = clothing, shoes, bags, accessories OR jewelry:\n"
        "  - Clothing (subniche='fashion'): shirts, t-shirts, blouses, tops,\n"
        "    sweaters, hoodies, jackets, coats, dresses, skirts, pants, jeans,\n"
        "    shorts, leggings, jumpsuits, swimwear, lingerie, sleepwear, activewear.\n"
        "  - Shoes (subniche='fashion'): sneakers, boots, heels, sandals, flats,\n"
        "    loafers, slippers.\n"
        "  - Bags (subniche='bags'): handbags, backpacks, totes, clutches, wallets,\n"
        "    crossbody bags, pouches.\n"
        "  - Accessories (subniche='accessories'): hats, caps, beanies, scarves,\n"
        "    belts, sunglasses, gloves, ties, umbrellas.\n"
        "  - Jewelry (subniche='jewelry'): necklaces, earrings, rings, bracelets,\n"
        "    pendants, watches, anklets, brooches, chokers.\n\n"
