...
async def _classify_batch_with_gemini(batch: list, api_key: str, model: str):
    ...
    prompt = (
        ...
        "  - General feed (is_fashion=false, subniche != exclude): everything\n"
        "    else, grouped by subniche.\n"
        ...
        "  1. is_fashion: true ONLY for clothing/shoes/bags. False otherwise.\n"
        ...
        "     - other            (a real product that doesn't fit any category above)\n"
        ...
        "When is_fashion=true you MUST set subniche='fashion'. When the title or\n"
        "type makes it CLEAR this is a checkout add-on (e.g. 'Versicherter Versand',\n"
        "'Shipping Protection', 'Geschenkkarte', 'Extended Warranty') you MUST\n"
        "set subniche='exclude'. Be strict.\n\n"
