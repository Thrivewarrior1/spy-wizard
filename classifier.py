...
async def _classify_batch_with_gemini(batch: list, api_key: str, model: str):
    ...
    prompt = (
        ...
        "  3. tags: emit ALL applicable tags from the controlled vocabularies\n"
        "     below as a single comma-separated lowercase string. BE GENEROUS\n"
        "     — include every tag that plausibly applies; a satin halter\n"
        "     floor-length gown should get prom AND wedding-guest AND evening\n"
        "     AND formal AND cocktail AND ball AND gown AND maxi AND halter\n"
        "     AND satin AND women. The user searches by these tags in\n"
        "     English regardless of the source language, so translate non-\n"
        "     English titles into the canonical English vocabulary.\n\n"
        "     CONTROLLED VOCABULARIES (use these exact tokens — do not\n"
        "     invent variants):\n\n"
        "     OCCASION (apparel / footwear / bags / accessories only):\n"
        ...
        "     NECKLINE: v-neck, crew-neck, square-neck, halter, off-shoulder,\n"
        "       one-shoulder, strapless, sweetheart, high-neck, cowl,\n"
        "       boat-neck, scoop-neck, plunge.\n\n"
        "     SLEEVE: long-sleeve, short-sleeve, sleeveless, cap-sleeve,\n"
        "       puff-sleeve, bell-sleeve, three-quarter-sleeve.\n\n"
        "     MATERIAL: silk, satin, lace, chiffon, sequin, velvet, tulle,\n"
        "       cotton, linen, denim, leather, suede, wool, cashmere, knit,\n"
        "       mesh, crochet, fleece, polyester, viscose, rayon, organza,\n"
        "       jersey, ribbed, faux-fur, faux-leather.\n\n"
        "     COLOR (only when clearly evident from title or product name):\n"
        "       black, white, red, blue, navy, green, pink, beige, ivory,\n"
        "       champagne, gold, silver, brown, cream, burgundy, emerald,\n"
        "       floral, striped, animal-print, metallic, pastel, neutral.\n\n"
        "     GENDER: women, men, unisex, kids, plus-size, petite.\n\n"
        "     PLUS 2-4 free English nouns identifying the product type itself\n"
        "       (e.g. 'dress, gown' or 'bag, tote, crossbody' or 'shoe,\n"
        "       heel, pump' or 'watch, smartwatch' or 'lamp, table-lamp').\n\n"
        "     For NON-FASHION products (electronics / home / beauty /\n"
        "     health / food / toys-books / other), skip the apparel-only\n"
        "     vocabularies and instead emit 4-10 category-appropriate\n"
        "     keywords describing what it is, who it's for, what it does\n"
        "     (e.g. 'smartwatch, fitness, heart-rate, sleep-tracking,\n"
        "     bluetooth, men, sports').\n\n"
        "     Examples of GOOD tag strings (notice the breadth):\n"
        "       'Sequin Halter Prom Gown' →\n"
        "         prom, wedding-guest, evening, formal, cocktail, ball,\n"
        "         party, gala, gown, maxi, halter, sequin, sleeveless, women\n"
        "       'Abendkleid mit Spitze' →\n"
        "         evening, prom, wedding-guest, cocktail, formal, ball,\n"
        "         party, dress, maxi, lace, women\n"
        "       'Robe de Mariée Bohème en Dentelle' →\n"
        "         wedding, bridal, formal, gown, maxi, lace, boho, women\n"
        "       'Comfort Memory Foam Plantar Fasciitis Sandals' →\n"
        "         sandal, orthopedic, plantar-fasciitis, memory-foam,\n"
        "         arch-support, comfort, summer, casual, women\n\n"
