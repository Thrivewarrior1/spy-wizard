...
# The strict-match JUDGE. Kept on flash-lite by default — flash
# (regular) is slower and ran into timeouts under prod load,
# causing fail-open and a 20-random-pants result for "lederhosen".
# Flash-lite + the worked-example prompt is a better cost/latency
# tradeoff for our scale.
_JUDGE_MODEL = os.getenv("SEARCH_JUDGE_MODEL", "gemini-2.5-flash-lite")
_JUDGE_FALLBACK_MODELS = ["gemini-2.5-flash", "gemini-flash-latest"]
